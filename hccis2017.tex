...
\begin{figure}[h] % TODO Change to scatter plot with trendlines plotting deviations in each user-angles against deviation from actual positions.
   \centering
...
% TODO Discussion of the `North' instruction causing confusion initially and how the use of rotating a box to align with the walls of a rectangular room could be a more intuitive solution.

% TODO Discussion of a future version of the technique taking advantage of modern devices having in-built compasses.
% - If the angle between the line from landmark to landmark and actual North is known, this removes the need to draw the `North' line.
% - Are the compasses accurate enough for this technique? Note: compass accuracies differ between devices.
% - Defeats the low tech nature of this solutions which currently requires a form of user input (could even be in-direct).
