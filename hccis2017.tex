...
The study reveals that the magnitude of a user's inaccuracies is proportional to the size of the error in the result.
\end{abstract}
...
% New results = new things to discuss?
